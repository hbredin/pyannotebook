...
# -*- coding: utf-8 -*-
#
# pyannotebook documentation build configuration file
#
...
project = 'pyannotebook'
copyright = '2022, Hervé Bredin'
author = 'Hervé Bredin'
...
_version_py = os.path.join(repo, 'pyannotebook', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pyannotebookdoc'
...
latex_documents = [
    (master_doc, 'pyannotebook.tex', 'pyannotebook Documentation',
     'Hervé Bredin', 'manual'),
]
